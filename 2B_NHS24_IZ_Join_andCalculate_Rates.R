...
input_IZ_2020 <- "IntZone2011_NHS24_Completed_Calls_20200301_to_20200531"
input_IZ_2019 <- "IntZone2011_NHS24_Completed_Calls_20190301_to_20190531"
...
IZ_2020 <- read_csv(glue("{filepath_IZ_data_in}/{input_IZ_2020}.csv")) %>% 
  select(intzone2011, 
         ...
         completed_calls_nhs24_2020_below5) 
...
IZ_2019 <- read_csv(glue("{filepath_IZ_data_in}/{input_IZ_2019}.csv")) %>% 
  select(intzone2011, 
         ...
         completed_calls_nhs24_2019_below5)
...
IZ2020_2019_Totals <- IZ_2020_2019 %>% 
    summarise_at(vars(completed_calls_nhs24_2019, completed_calls_nhs24_2020),
         sum) %>% 
  mutate(intzone2011 = "Total_NHS24_Calls")
  

IZ2020_2019_Summary <- bind_rows(IZ2020_2019_Totals, IZ2020_2019_Unmatched)

write.csv(IZ2020_2019_Summary,
          (glue("{filepath_checks}/IZ2020_2019_NHS24Calls_Summary_{date_range}.csv")))
...
IZ2020_2019_IZ_with_Calls_below5 <- IZ2020_2019_Join_to_Lookup_File %>% 
  summarise_at(vars(completed_calls_nhs24_2019_below5, 
                    completed_calls_nhs24_2020_below5),
               sum)

View(IZ2020_2019_IZ_with_Calls_below5 )

write.csv(IZ2020_2019_IZ_with_Calls_below5,
          (glue("{filepath_checks}/IZ2020_2019_IZ_NHS24Calls_below5_{date_range}.csv")))
...
IZ2011_NHS24_Calls <- IZ2020_2019_Join_to_Lookup_File %>% 
  select(intzone2011, intzone2011_name, HB, HBName,  
         completed_calls_nhs24_2019, completed_calls_nhs24_2020)
  

colnames(IZ2011_NHS24_Calls)
...
IZ2011_NHS24_Calls <- IZ2011_NHS24_Calls %>% 
  left_join(IZPops2018, by = "intzone2011") %>% 
  mutate(Calls_rate_per_1000_pop_2019 = (completed_calls_nhs24_2019/Total_Pop_IZ_2018)*1000) %>% 
  mutate(Calls_rate_per_1000_pop_2020 = (completed_calls_nhs24_2020/Total_Pop_IZ_2018)*1000) %>% 
    mutate(perc.diff.calls = ((Calls_rate_per_1000_pop_2020 - Calls_rate_per_1000_pop_2019)
                          /Calls_rate_per_1000_pop_2019)*100)
  

View(IZ2011_NHS24_Calls)


write.csv(IZ2011_NHS24_Calls,
          (glue("{filepath_outputs}/IZ2011_NHS24_Calls_{date_range}.csv")))


#### Step 6 - write out summary file - from wide data
####summarise minimum and maximum numbers, Rates, and change in final IZ file

IZ2011_NHS24_Calls_Min <- IZ2011_NHS24_Calls %>% 
  summarise_at(vars(completed_calls_nhs24_2019,
                    completed_calls_nhs24_2020,
                    Total_Pop_IZ_2018,
                    Calls_rate_per_1000_pop_2019,
                    Calls_rate_per_1000_pop_2020,
                    perc.diff.calls),
               min) %>% 
  mutate(Summary = "Min")

IZ2011_NHS24_Calls_Max <- IZ2011_NHS24_Calls %>% 
  summarise_at(vars(completed_calls_nhs24_2019,
                    completed_calls_nhs24_2020,
                    Total_Pop_IZ_2018,
                    Calls_rate_per_1000_pop_2019,
...
IZ2011_NHS24_Calls_Median <- IZ2011_NHS24_Calls %>% 
  summarise_at(vars(completed_calls_nhs24_2019,
                    completed_calls_nhs24_2020,
                    Total_Pop_IZ_2018,
                    Calls_rate_per_1000_pop_2019,
...
IZ2011_NHS24_Calls_Mean <- IZ2011_NHS24_Calls %>% 
  summarise_at(vars(completed_calls_nhs24_2019,
                    completed_calls_nhs24_2020,
                    Total_Pop_IZ_2018,
                    Calls_rate_per_1000_pop_2019,
...
IZ2011_NHS24_Calls_Total <- IZ2011_NHS24_Calls %>% 
  summarise_at(vars(completed_calls_nhs24_2019,
                    completed_calls_nhs24_2020,
                    Total_Pop_IZ_2018
                    ),
...
IZ2011_NHS24_Calls_Summary <- bind_rows(
  IZ2011_NHS24_Calls_Min,
  IZ2011_NHS24_Calls_Max,
  IZ2011_NHS24_Calls_Median,
  IZ2011_NHS24_Calls_Mean,
  IZ2011_NHS24_Calls_Total
)

View(IZ2011_NHS24_Calls_Summary)

write.csv(IZ2011_NHS24_Calls_Summary,
          (glue("{filepath_outputs}/IZ2011_NHS24_Calls_Summary_{date_range}.csv")))
