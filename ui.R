...
shinyUI(
             ...
             tabPanel("Summary",
                      fluidPage(
                        ...
                        sidebarPanel(style = "position:fixed;width:inherit;", width = 3, selectInput("selectHSCPsummary", "Select HSCP", choices = unique(iz$hscp), selected = "Glasgow City"),
                                     hr(),
                                     sliderInput("timeframesummary", "Weeks", min = 14, max = 30, 
                                                 ticks = TRUE, step = 1,  value = c(14,30),
                                                 dragRange = TRUE),
                                     ...
                                     bsTooltip("timeframesummary", "Week 14 beginning 1 Apr 2019 & 30 Mar 2020", options = list(container = "body"))),
  ...
  fluidPage(
             sidebarPanel(
               ...
               sliderInput("timeframe", "Weeks", min = 14, max = 30, 
                           ticks = TRUE, step = 1,  value = c(14,30),
                           dragRange = TRUE)),
